...
static void register_dump(int fd, struct ucontext_t *ctx)
{
    char regs[21][8];
    char fpregs[31][8];
    struct iovec iov[97];
...
#define ADD_MEM(str, len)   \
    ...
    hexvalue(ctx->__fpregs_mem._st[0].significand[3] << 16 | ctx->__fpregs_mem._st[0].significand[2], fpregs[8], 8);
    hexvalue(ctx->__fpregs_mem._st[0].significand[1] << 16 | ctx->__fpregs_mem._st[0].significand[0], fpregs[9], 8);
    hexvalue(ctx->__fpregs_mem._st[1].exponent, fpregs[10], 8);
    hexvalue(ctx->__fpregs_mem._st[1].significand[3] << 16 | ctx->__fpregs_mem._st[1].significand[2], fpregs[11], 8);
    hexvalue(ctx->__fpregs_mem._st[1].significand[1] << 16 | ctx->__fpregs_mem._st[1].significand[0], fpregs[12], 8);
    hexvalue(ctx->__fpregs_mem._st[2].exponent, fpregs[13], 8);
    hexvalue(ctx->__fpregs_mem._st[2].significand[3] << 16 | ctx->__fpregs_mem._st[2].significand[2], fpregs[14], 8);
    hexvalue(ctx->__fpregs_mem._st[2].significand[1] << 16 | ctx->__fpregs_mem._st[2].significand[0], fpregs[15], 8);
    hexvalue(ctx->__fpregs_mem._st[3].exponent, fpregs[16], 8);
    hexvalue(ctx->__fpregs_mem._st[3].significand[3] << 16 | ctx->__fpregs_mem._st[3].significand[2], fpregs[17], 8);
    hexvalue(ctx->__fpregs_mem._st[3].significand[1] << 16 | ctx->__fpregs_mem._st[3].significand[0], fpregs[18], 8);
    hexvalue(ctx->__fpregs_mem._st[4].exponent, fpregs[19], 8);
    hexvalue(ctx->__fpregs_mem._st[4].significand[3] << 16 | ctx->__fpregs_mem._st[4].significand[2], fpregs[20], 8);
    hexvalue(ctx->__fpregs_mem._st[4].significand[1] << 16 | ctx->__fpregs_mem._st[4].significand[0], fpregs[21], 8);
    hexvalue(ctx->__fpregs_mem._st[5].exponent, fpregs[22], 8);
    hexvalue(ctx->__fpregs_mem._st[5].significand[3] << 16 | ctx->__fpregs_mem._st[5].significand[2], fpregs[23], 8);
    hexvalue(ctx->__fpregs_mem._st[5].significand[1] << 16 | ctx->__fpregs_mem._st[5].significand[0], fpregs[24], 8);
    hexvalue(ctx->__fpregs_mem._st[6].exponent, fpregs[25], 8);
    hexvalue(ctx->__fpregs_mem._st[6].significand[3] << 16 | ctx->__fpregs_mem._st[6].significand[2], fpregs[26], 8);
    hexvalue(ctx->__fpregs_mem._st[6].significand[1] << 16 | ctx->__fpregs_mem._st[6].significand[0], fpregs[27], 8);
    hexvalue(ctx->__fpregs_mem._st[7].exponent, fpregs[28], 8);
    hexvalue(ctx->__fpregs_mem._st[7].significand[3] << 16 | ctx->__fpregs_mem._st[7].significand[2], fpregs[29], 8);
    hexvalue(ctx->__fpregs_mem._st[7].significand[1] << 16 | ctx->__fpregs_mem._st[7].significand[0], fpregs[30], 8);
