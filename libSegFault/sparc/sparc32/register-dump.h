...
static void register_dump(int fd, void *ctx)
{
    char regs[36][8];
    char fregs[68][8];
...
#define ADD_MEM(str, len)   \
    ...
    {
        struct __siginfo_sparc64_fpu *f = *(struct __siginfo_sparc64_fpu **)(mask + 1);
    ...
    {
        struct __siginfo_sparc32_fpu *f = *(struct __siginfo_sparc32_fpu **)(mask + 1);
