...
#if (2 <= __GNUC__ || (4 <= __clang_major__) || (1210 <= __IBMC__ && defined __IBM__TYPEOF__) || (0x5110 <= __SUNPRO_C && !__STDC__))
...
#define _GL_BINARY_OP_OVERFLOW(a, b, op_result_overflow) \
    op_result_overflow(a, b, _GL_INT_MINIMUM(_GL_INT_CONVERT(a, b)), _GL_INT_MAXIMUM(_GL_INT_CONVERT(a, b)))
...
#if ((9 < __GNUC__ + (3 <= __GNUC_MINOR__) || (__GNUC__ == 8 && 4 <= __GNUC_MINOR__)) && !defined __ICC)
...
#define _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, st, smin, smax, ut, umax)                          \
    (TYPE_SIGNED(__typeof__(*(r))) ? _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int, st, smin, smax) : \
                                     _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int, ut, 0, umax))
#else
#define _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, st, smin, smax, ut, umax)                    \
    (overflow(a, b, smin, smax) ?                                                                     \
     (overflow(a, b, 0, umax) ? (*(r) = _GL_INT_OP_WRAPV_VIA_UNSIGNED(a, b, op, unsigned, st), 1) :   \
                                (*(r) = _GL_INT_OP_WRAPV_VIA_UNSIGNED(a, b, op, unsigned, st)) < 0) : \
     (overflow(a, b, 0, umax) ? (*(r) = _GL_INT_OP_WRAPV_VIA_UNSIGNED(a, b, op, unsigned, st)) >= 0 : \
                                (*(r) = _GL_INT_OP_WRAPV_VIA_UNSIGNED(a, b, op, unsigned, st), 0)))
#endif

#define _GL_INT_OP_WRAPV(a, b, r, op, overflow)                                                                       \
    (sizeof *(r) == sizeof(signed char) ?                                                                             \
     _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, signed char, SCHAR_MIN, SCHAR_MAX, unsigned char, UCHAR_MAX) :  \
     sizeof *(r) == sizeof(short int) ?                                                                               \
     _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, short int, SHRT_MIN, SHRT_MAX, unsigned short int, USHRT_MAX) : \
     sizeof *(r) == sizeof(int) ?                                                                                     \
     (EXPR_SIGNED(*(r)) ? _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int, int, INT_MIN, INT_MAX) :               \
                          _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int, unsigned int, 0, UINT_MAX)) :          \
     _GL_INT_OP_WRAPV_LONGISH(a, b, r, op, overflow))
#ifdef LLONG_MAX
#define _GL_INT_OP_WRAPV_LONGISH(a, b, r, op, overflow)                                                                         \
    (sizeof *(r) == sizeof(long int) ?                                                                                          \
     (EXPR_SIGNED(*(r)) ? _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long int, long int, LONG_MIN, LONG_MAX) :             \
                          _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long int, unsigned long int, 0, ULONG_MAX)) :         \
     (EXPR_SIGNED(*(r)) ? _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long long int, long long int, LLONG_MIN, LLONG_MAX) : \
                          _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long long int, unsigned long long int, 0, ULLONG_MAX)))
#else
#define _GL_INT_OP_WRAPV_LONGISH(a, b, r, op, overflow)                                                            \
    (EXPR_SIGNED(*(r)) ? _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long int, long int, LONG_MIN, LONG_MAX) : \
                         _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long int, unsigned long int, 0, ULONG_MAX))
...
#define _GL_INT_ADD_RANGE_OVERFLOW(a, b, tmin, tmax)                                                                          \
    ((b) < 0 ?                                                                                                                \
     (((tmin) ? ((EXPR_SIGNED(_GL_INT_CONVERT(a, (tmin) - (b))) || (b) < (tmin)) && (a) < (tmin) - (b)) : (a) <= -1 - (b)) || \
      ((EXPR_SIGNED(a) ? 0 <= (a) : (tmax) < (a)) && (tmax) < (a) + (b))) :                                                   \
     (a) < 0 ?                                                                                                                \
     (((tmin) ? ((EXPR_SIGNED(_GL_INT_CONVERT(b, (tmin) - (a))) || (a) < (tmin)) && (b) < (tmin) - (a)) : (b) <= -1 - (a)) || \
      ((EXPR_SIGNED(_GL_INT_CONVERT(a, b)) || (tmax) < (b)) && (tmax) < (a) + (b))) :                                         \
     (tmax) < (b) || (tmax) - (b) < (a))
#define _GL_INT_SUBTRACT_RANGE_OVERFLOW(a, b, tmin, tmax)                                                                            \
    (((a) < 0) == ((b) < 0) ? ((a) < (b) ? !(tmin) || -1 - (tmin) < (b) - (a) - 1 : (tmax) < (a) - (b)) :                            \
     (a) < 0 ? ((!EXPR_SIGNED(_GL_INT_CONVERT((a) - (tmin), b)) && (a) - (tmin) < 0) || (a) - (tmin) < (b)) :                        \
               ((!(EXPR_SIGNED(_GL_INT_CONVERT(tmax, b)) && EXPR_SIGNED(_GL_INT_CONVERT((tmax) + (b), a))) && (tmax) <= -1 - (b)) || \
                (tmax) + (b) < (a)))
#define _GL_INT_MULTIPLY_RANGE_OVERFLOW(a, b, tmin, tmax)                                                                       \
    ((b) < 0 ?                                                                                                                  \
     ((a) < 0 ? (EXPR_SIGNED(_GL_INT_CONVERT(tmax, b)) ?                                                                        \
                 (a) < (tmax) / (b) :                                                                                           \
                 ((INT_NEGATE_OVERFLOW(b) ? _GL_INT_CONVERT(b, tmax) >> (TYPE_WIDTH(+(b)) - 1) : (tmax) / -(b)) <= -1 - (a))) : \
      INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(b, tmin)) && (b) == -1 ?                                                              \
                (EXPR_SIGNED(a) ? 0 < (a) + (tmin) : 0 < (a) && -1 - (tmin) < (a) - 1) :                                        \
                (tmin) / (b) < (a)) :                                                                                           \
     (b) == 0 ? 0 :                                                                                                             \
                ((a) < 0 ? (INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(a, tmin)) && (a) == -1 ?                                        \
